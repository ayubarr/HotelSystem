namespace HotelSystem.WinForm
{
	partial class InfoMenuForm
	{
		...
		private void InitializeComponent()
		{
			...
			label_Reservation.Location = new Point(101, 303);
			...
			// button_InfoGuest
			// 
			button_InfoGuest.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point);
			button_InfoGuest.Location = new Point(40, 330);
			button_InfoGuest.Margin = new Padding(3, 2, 3, 2);
			button_InfoGuest.Name = "button_InfoGuest";
			button_InfoGuest.Size = new Size(360, 38);
			button_InfoGuest.TabIndex = 20;
			button_InfoGuest.Text = "Информация о клиентах";
			button_InfoGuest.UseVisualStyleBackColor = true;
			button_InfoGuest.Click += button_InfoGuest_Click;
			// 
			// listBox1
			// 
			...
			dataGridView1.Location = new Point(40, 404);
			dataGridView1.Name = "dataGridView1";
			dataGridView1.RowTemplate.Height = 25;
			dataGridView1.Size = new Size(360, 175);
		...
		private Button button_InfoGuest;
